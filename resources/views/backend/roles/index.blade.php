...
@section('title', 'RetroAPPS Tech Blog | Roles')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Roles <small style="font-size: 15px">Display All Roles</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="breadcrumb-item"><a href="{{ url('/blog.index') }}">Role</a></li>
	    ...
	    <section class="content">
	      <div class="container-fluid">
	              ...
	              <div class="card-body p-1">
  	              	<div class="row">
  	              		<div class="col-md-6" style="padding-left: 10px; padding-right: 30px; padding-top: 10px; padding-bottom: 10px; ">
  	              			<a href="{{ route('backend.roles.create') }}" class="btn btn-info float-left">
  	              			  <span>
			...
			<div class="card-footer clearfix">
				...
				<div class="pull-right">
					<?php $rolesCount = $roles->count();?>
					<small style="padding-right: 25px;">{{ $rolesCount }} out of {{ $rolesCount }} {{ str_plural('Items', $rolesCount) }}</small>
				</div>
			</div>			                    	                	              
        </div>
        <!-- /.card -->
